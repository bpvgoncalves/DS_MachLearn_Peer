...
Playing around with the Poisson distribution, an assuming an average 'miss ratio' of 1.5 predictions out of every 100 attempts, we can compute a `r (ppois(0, 20*1.5/100, lower=TRUE))*100` percent probability of the 20/20 performance achieved (ie, 0 misses in 20 attempts, given a probability of missing 1.5 classifications in every 100).  
<br>
